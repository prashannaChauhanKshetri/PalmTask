...
| LLM Generation | **OpenAI `gpt-4o-mini`** | Used for both RAG answer generation and structured JSON extraction for bookings. |
...
| 7 | **LLM Generation** | OpenAI `gpt-4o-mini` with temperature 0.2 for high precision. |
